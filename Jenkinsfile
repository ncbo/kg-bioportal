pipeline {
    ...
    environment {
        ...
        ONTOSET = 'MARC-LANGUAGES,UPA,MIXS,ICD11-BODYSYSTEM,DDANAT,LHN,HIVMT,HCPCS,OOSTT,HO,REPO,CHD,PMO,VDOT,IRD,PLANA,SNMI,OMV,SENSO,CARELEX,MOSAIC,CTCAE,FISH-AST,ISO19115DI,SSN,ONTOPBM,SEPIO,CIINTEADO,EPIO,OBI_BCGO,LANDFORM,INCENTIVE-VARS,DTO,ONL-MR-DA,NEICBEER,ECG,SDO,OMIT,ECOCORE,COKPME,ECTO,APANEUROCLUSTER,OBCS,SURGICAL,MSV,ENVTHES,PMDO,CISAVIADO,BMT,EP,CNO,IAML-MOP,GRO-CPGA,EDAM,MFMO,MFOEM,CDAO,PSDS,BT,VIVO'
    }
    options {
        timestamps()
