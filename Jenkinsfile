pipeline {
    ...
    environment {
        ...
        ONTOSET = 'FCC1,HO,DCTERMS,DIKB,NIGO,BCTEO,PE-O,EHDAA,PNADO,ATOL,PEO,FAST-EVENT,ZFA,BRCT,CTONT,DCT,RCTV2,CRISP,OPTION-ONTOLOGY,ONTOPNEUMO,HMISLAB0115,BIBLIOTEK-O,NMOSP,KTAO,STATO,ADO,HDMPONTO,ADMIN,TEST_CBI,PROPREO,HASCO,OMRSE,SPO,OBS,GEO,VODANA-MPA,PHYLONT,INFRARISK,CARELEX,UPA,EO1,TML,PDUMDV,CEDARVS,OGMS,SCHEMA,HOM,PREMEDONTO,BCO,ODNAE,WETAXTOPICS,ZONMW-CONTENT,VO,RO,APATREATMENT,SPTO,ONTOAD,CODO,IDQA,MARC-RELATORS,RNRMU,APAOCUEMPLOY,ECP,ESSO,MATR,FAST-GENREFORM,FHHO,TTO,BCS8,CTO,APO,MDM,NPOKB,ISO19115MI,MOOCULADO,ICD11-BODYSYSTEM,ISO19115CON,NIO,SYMP,FISH-AST,OGG,LABO,EXACT,PE,HTN,ADHER_INTCARE_SP,XPO,GSSO,ONTODT,OPDZIMBABWE,GCO,NOMEN,ICEO,MSO,LAND-SURFACE,COVID-19-ONT-PM,UGANDA_DISEASES,EXTRACT,MSTDE,PMO-SPEED,EBP,CSO,BSAO,OSM,ORNASEQ,EPIP,RETO,MIRO,OGDI,ELIG,TADS,COVIDCRFRAPID,OHMI,ICD10,SOCPRES,IMGT-ONTOLOGY,ILLNESSINJURY,HOOM,EMAP,NDFRT,MHCRO,SSN,WC,AMINO-ACID,RAO,ISO19115CC,FAO,TOK,OPDE,CISAVIADO,CNO_ACRONYM,BKO,CCTOO,EPISEM,FAST-FORMGENRE,GDCO,HGNC,ISO19115PR,OAE,BRIDG,EO,OMV,OA,OPL,FPLX,CN,EUPATH,PDO,ICPS,EMIF-AD,CTENO,MARC-LANGUAGES,VANDF,AISM,MOSAIC,ECAO,ODAE,NATPRO,PDRO,PMR,EDAM,OBCS,LOINC,SAO,EPIO,CABRO,FO,SNMI,MFOMD,CSSO,PREO,LEGALAPATEST2,DERMLEX,ADMO,GML,PATIT,CHIRO,KISAO,LC-CARRIERS,ENM'
    }
    options {
        timestamps()
